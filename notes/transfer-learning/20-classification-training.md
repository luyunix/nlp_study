# 第 20 节：中文分类案例（四）：训练循环、梯度更新和学习率调度

> 笔记编号 20/29 · 对应原视频 P174 · [打开这一集](https://www.bilibili.com/video/BV14mdfBDE4Q?p=174)

[← 上一节：19 中文分类案例（三）：自定义 BERT + Linear(768→2) 网络](./19-classification-model.md) · [返回总目录](./README.md) · [下一节：21 中文分类案例（五）：eval/no_grad、准确率与保存最佳模型 →](./21-classification-evaluation.md)
